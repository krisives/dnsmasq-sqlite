...
objs = cache.o rfc1035.o util.o option.o forward.o network.o \
       ...
       poll.o rrfilter.o edns0.o arp.o crypto.o dump.o ubus.o metrics.o db.c
...
all-i18n : $(BUILDDIR)
 ...
 build_cflags="$(version) $(dbus_cflags) $(idn2_cflags) $(idn_cflags) $(ct_cflags) $(lua_cflags) $(nettle_cflags) $(sqlite_cflags)" \
 build_libs="$(dbus_libs) $(idn2_libs) $(idn_libs) $(ct_libs) $(lua_libs) $(sunos_libs) $(nettle_libs) $(gmp_libs) $(sqlite_libs)"  \
 -f $(top)/Makefile dnsmasq
